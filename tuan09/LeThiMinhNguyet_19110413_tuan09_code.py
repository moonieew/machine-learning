...
if let_plot:
    ...
    plt.show()
#dữ liệu giả lập ra từ model bậc 2

#%% 6.2. Add high-order features
#dùng hàm có sẵn PolynomialFeatures để thêm bậc (bậc 2)
...
if let_plot:
    ...
    #plt.axis([-3, 3, 0, 10])
    plt.show()
#màu đen là dữ liệu của mình
#màu xanh là học ra từ normal Eq, 2 đường đi khá là sát nhau


# In[7]: LEARNING CURVES
#đường bậc 2 là đường parobol rất hợp lý
#bậc 1 là đường thẳng thì không nằm gần hết những cái điểm được
#bậc 200 sẽ cố gắng đi qua tất cả các điểm trong tập train giảm error xuống thấp sẽ xảy ra overfiting, ở trong tập valication sẽ kh tốt 
...
#a=0 là đường màu xanh rất khớp với đường màu đen đây là điều mình mong muốn 
#a=20 đường hơi ngang 
#a=1000 nằm ngang luôn bị underfiting
